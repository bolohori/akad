...
function akad_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'akad' ),
	) );
...
function akad_scripts() {
	...
	//wp_enqueue_style( 'akad-custom', get_template_directory_uri().'/custom.css' );  //this gets the custom.css from the theme root directory.
