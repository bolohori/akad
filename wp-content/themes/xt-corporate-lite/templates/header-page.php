...
if(function_exists('get_field')){
    $display = 1;
    if(get_field('display_header_title',get_the_ID()) == 0){
        $display = 0;
    }

    $tagline = '';
    if(get_field('page_tag_line') != ''){
        $tagline = get_field('page_tag_line');
    }
}else{
    $display = 1;
    $tagline = '';
    ...
    <div class="page_header">
        <div class="container">
            <div class="page-title">
                ...
                <p><?php echo esc_textarea($tagline); ?></p>
            </div>
        </div>
    </div>
    <?php
}else{
    echo "<div class='top70'></div>";
}
?>
